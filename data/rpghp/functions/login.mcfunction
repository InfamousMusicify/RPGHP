...
execute unless score #login_heal rpghp.config matches 1.. unless score @s rpghp.config matches 2.. as @s[scores={rpghp.hptrack=21..}] run effect give @s minecraft:instant_health 1 252
