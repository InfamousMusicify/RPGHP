...
execute if score @s rpghp.xptrack >= @s rpghp.xpmult if score @s rpghp.hptrack < #max_hp rpghp.config run function rpghp:xp_checker_lvl
# negative -loop loss level
execute if score @s rpghp.xptrack matches ..-1 run function rpghp:xp_checker_lvl