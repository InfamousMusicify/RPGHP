...
tellraw @s {"text":"                                                                                ","color":"dark_gray","strikethrough":true}
tellraw @s ["",{"text":"[ ✎ ]","color":"gray","clickEvent":{"action":"suggest_command","value":"/scoreboard players set #exp_checker rpghp.config "},"hoverEvent":{"action":"show_text","contents":["",{"text":"Click to toggle exp vs level check.\n(for roleplay and custom games, or OCD)","color":"gray"},{"text":"\nAccepts: whole numbers 0+\nDefault: 1\n0=OFF 1=Full 2=Raw 3=Level_Based","color":"dark_gray"}]}}," EXP Checker ",{"text":"(Current: ","color":"gray"},{"score":{"name":"#exp_checker","objective":"rpghp.config"},"color":"gray"},{"text":")","color":"gray"}]
tellraw @s ["",{"text":"[ ✎ ]","color":"gray","clickEvent":{"action":"suggest_command","value":"/scoreboard players set #xp_math rpghp.config "},"hoverEvent":{"action":"show_text","contents":["",{"text":"Click to edit exp math mode.\n(full or level based)","color":"gray"},{"text":"\nAccepts: whole numbers 0+\nDefault: 0\n0=Full 1=Level_Based","color":"dark_gray"}]}}," XP Math Mode ",{"text":"(Current: ","color":"gray"},{"score":{"name":"#xp_math","objective":"rpghp.config"},"color":"gray"},{"text":")","color":"gray"}]
