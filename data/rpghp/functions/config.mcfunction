...
tellraw @s {"text":"                                                                                ","color":"dark_gray","strikethrough":true}
tellraw @s ["",{"text":"[ ✎ ]","color":"gray","clickEvent":{"action":"suggest_command","value":"/scoreboard players set #exp_checker rpghp.config "},"hoverEvent":{"action":"show_text","contents":["",{"text":"Click to toggle exp vs level check.\n(for roleplay and custom games, or OCD)\n(reload to enable)","color":"gray"},{"text":"\nAccepts: whole numbers 0+\nDefault: 1\n0=ON 1=OFF","color":"dark_gray"}]}}," EXP Checker ",{"text":"(Current: ","color":"gray"},{"score":{"name":"#exp_checker","objective":"rpghp.config"},"color":"gray"},{"text":")","color":"gray"}]
