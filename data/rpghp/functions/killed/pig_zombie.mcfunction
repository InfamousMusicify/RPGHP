...
# negative
execute if score #pig_zombie rpghp.config matches ..-1 unless score @s rpghp.xpcount matches ..0 run scoreboard players operation @s rpghp.xp += #pig_zombie rpghp.config
# xp_math - health
