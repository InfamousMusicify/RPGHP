...
# negative
execute if score #wither_skeleton rpghp.config matches ..-1 unless score @s rpghp.xpcount matches ..0 run scoreboard players operation @s rpghp.xp += #wither_skeleton rpghp.config
# xp_math - health
