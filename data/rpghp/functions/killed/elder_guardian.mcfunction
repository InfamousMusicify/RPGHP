...
# negative
execute if score #elder_guardian rpghp.config matches ..-1 unless score @s rpghp.xpcount matches ..0 run scoreboard players operation @s rpghp.xp += #elder_guardian rpghp.config
# xp_math - health
