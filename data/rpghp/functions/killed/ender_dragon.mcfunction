...
execute if score @s rpghp.hptrack < #max_hp rpghp.config run scoreboard players operation @s rpghp.xp += #ender_dragon rpghp.config
# xp_math - health
...
# revoke adv
advancement revoke @s only rpghp:killed/ender_dragon
