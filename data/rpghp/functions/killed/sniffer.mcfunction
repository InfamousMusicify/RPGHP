...
# negative
execute if score #sniffer rpghp.config matches ..-1 unless score @s rpghp.xpcount matches ..0 run scoreboard players operation @s rpghp.xp += #sniffer rpghp.config
# xp_math - health
