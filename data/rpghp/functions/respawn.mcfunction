...
execute unless score #death rpghp.config matches ..-1 if score @s rpghp.hptrack < #max_hp rpghp.config run scoreboard players operation @s rpghp.xp += #death rpghp.config
# negatives
execute if score #death rpghp.config matches ..-1 unless score @s rpghp.xpcount matches ..0 run scoreboard players operation @s rpghp.xp += #death rpghp.config
# xp_math - health
execute unless score #death rpghp.config matches ..-1 if score @s rpghp.hptrack < #max_hp rpghp.config run function rpghp:xp_math
execute if score #death rpghp.config matches ..-1 run function rpghp:xp_math
